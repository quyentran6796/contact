    ...
    <div class="col-md-12">
            ...
            <div class="panel panel-info">
                ...
                @if($errors->has('contact_message') )
                    <div class="alert alert-danger">{!! $errors->first('contact_message') !!}</div>
                @endif
                ...
                @if($errors->has('contact_company') )
                    <div class="alert alert-danger">{!! $errors->first('contact_company') !!}</div>
                @endif
                ...
                <div class="panel-body">
                    <div class="row">
                        <div class="col-md-12 col-xs-12">
                            ...
                            <!-- SAMPLE NAME TEXT-->
                            @include('contact::contact.elements.text', ['name' => 'contact_name', 'email' => 'contact_email', 'message' => 'contact_message', 'phone' => 'contact_phone', 'company' => 'contact_company'])
